...
{
    static SNCoreDataH *coreDataDBHelper = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        coreDataDBHelper = [[SNCoreDataH alloc] init];
    });
...
{
    NSManagedObject *entity = [NSEntityDescription insertNewObjectForEntityForName:modelName inManagedObjectContext:_managedObjectContext];
